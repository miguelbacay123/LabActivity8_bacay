    ...
    <form method="POST" action="<?php echo e(route('posts.update', $post->id)); ?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <?php if($post->image_path): ?>
                <p>Current image:</p>
                <img src="<?php echo e(asset('storage/' . $post->image_path)); ?>" alt="Post image" width="200">
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\blogs\Laravel-Image-main\resources\views/posts/edit.blade.php ENDPATH**/ ?>